...
##GEEITNG MISTAKES IN INTERMEDIATE NODE
...
def intermediate_node_num_mistakes(labels_in_node):
    ...
    ##DEFINING BEST SPLITTING FEATURE
...
##CREATING  DECISION TREES WITH DIFFERENT DEPTHS
...
def classify(tree, x, annotate = False):   
  ...
  ##PREDICT CLASS FOR 1ST TEST DATA ENTRY
